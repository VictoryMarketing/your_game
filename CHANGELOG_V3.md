...
## 2026-07-20 — Бесплатные готовые приключения

- Добавлен отдельный режим заранее написанных ветвящихся книг без текстовых LLM-запросов во время прохождения.
- Подготовлены уютный детектив и современный любовный роман на 10 глав, а также ромэнтези на 30 глав; у каждой книги три смысловых пути и шесть полноценных финалов.
- Готовые книги не расходуют главы, не допускают свободный ввод и предметы, но поддерживают платные иллюстрации и озвучку.
- Переходы между готовыми главами выполняются напрямую, без очереди генерации и ожидания модели.
- Экран новой истории и открытая библиотека получили заметные кнопки «Играть бесплатно».
- Три контрольных прохождения опубликованы в библиотеке и добавлены в игровой рейтинг, но исключены из продуктовой аналитики администратора.
- Добавлены offline-валидатор контента, полный тест игрового потока, checkpoints генератора и идемпотентный seed публикаций.
